...
class PacientesForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'parentesco_acompanante': forms.Select(choices=[('1', 'NINGUNO'), ('2', 'PADRE'), ('3', 'MADRE'), ('4', 'HERMANO(A)'), ('5', 'TIO(A)'), ('6', 'ABUELO(A)'), ('7', 'CUÑADO(A)'), ('8', 'HIJO(A)'), ('9', 'ESPOSO(A)'), ('10', 'COMPAÑERO(A)'), ('11', 'SOBRINO(A)')]),
