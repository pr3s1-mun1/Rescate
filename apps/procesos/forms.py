...
class PacientesForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'pulso_diagnostico': forms.Select(choices=[
                ('1', 'REGULAR'),
                ('2', 'IRREGULAR'),
                ('3', 'LLENO'),
                ('4', 'DEBIL'),
            ...
            'respiracion_diagnostico': forms.Select(choices=[
                ('1', 'NORMAL'),
                ('2', 'SUPERFICIAL'),
                ('3', 'LABORIOSA'),
                ('4', 'APNEA'),
            ...
            'hemorragia': forms.Select(choices=[
                ('1', 'NO'),
                ('2', 'MINIMA'),
                ('3', 'MODERADA'),
                ('4', 'SEVERA'),
            ]),
            'dolor': forms.Select(choices=[
                ('1', 'NO'),
                ('2', 'MINIMO'),
                ('3', 'MODERADO'),
                ('4', 'SEVERO'),
            ]),
            'apertura_ojos_glasgow': forms.Select(choices=[
                ('1', 'NO EVALUADO'),
                ('2', 'ESPONTANEO'),
            ...
            'respuesta_verbal_glasgow': forms.Select(choices=[
                ('1', 'ORIENTADO EN 3 ESFERAS'),
                ('2', 'CONFUSO PERO CONTESTA'),
                ('3', 'PALABRAS INCOHERENTES'),
                ('4', 'PALABRAS INCOMPRENSIBLES'),
                ('5', 'NO HAY RESPUESTA'),
                ('6', 'NO EVALUADO'),
            ]),
            'respuesta_motora_glasgow': forms.Select(choices=[
                ('1', 'NO EVALUADO'),
                ('2', 'OBEDECE ORDENES'),
                ('3', 'LOCALIZA DOLOR'),
                ('4', 'RECHAZO AL DOLOR'),
                ('5', 'FLEXION ANORMAL AL DOLOR'),
                ('6', 'EXTENSION ANORMAL AL DOLOR'),
                ('7', 'NO RESPUESTA'),
            ]),
            'edad_tipo': forms.Select(choices=[
                ('1', 'DIAS'),
                ('2', 'SEMANAS'),
                ('3', 'MESES'),
                ('4', 'AÑOS'),
            ]),
            'color_vehiculo': forms.Select(choices=[
                ('1', 'NINGUNO'),
                ('2', 'BLANCO'),
                ('3', 'NEGRO'),
                ('4', 'ROJO'),
            ...
            'parentesco_acompanante': forms.Select(choices=[
                ('1', 'NINGUNO'),
                ('2', 'PADRE'),
                ('3', 'MADRE'),
                ('4', 'HERMANO(A)'),
