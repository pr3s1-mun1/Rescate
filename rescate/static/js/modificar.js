...
document.addEventListener('DOMContentLoaded', function () {
    const pestañasAValidar = ['servicio', 'unidad', 'paramedicos', 'paciente', 'pertenencias', 'procedimiento', 'alergia', 'material', 'ingerido', 'administrado', 'equipo', 'lesion', 'impacto', 'partes'];
